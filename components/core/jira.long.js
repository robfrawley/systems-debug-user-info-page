...
; /* module-key = 'com.atlassian.jira.collector.plugin.jira-issue-collector-plugin:issuecollector-embededjs', location = '/js/collector/bootstrap.js' */
...
(function($) {
    ...
    ATL_JQ.IssueDialog = function(options) {
        ...
        if (!options.baseUrl) {
            options.baseUrl = "https://issues.scribe.software"
        }
        ...
        if (this.options.triggerPosition === "CUSTOM") {
            ...
            $(function() {
                try {
                    ...
                    if (window.ATL_JQ_PAGE_PROPS && ((window.ATL_JQ_PAGE_PROPS.triggerFunction) || (window.ATL_JQ_PAGE_PROPS["cf33aa12"] && window.ATL_JQ_PAGE_PROPS["cf33aa12"].triggerFunction))) {
                        newTriggerFunction = window.ATL_JQ_PAGE_PROPS.triggerFunction || window.ATL_JQ_PAGE_PROPS["cf33aa12"].triggerFunction
                    } else {
    ...
    ATL_JQ.IssueDialog.prototype = {
        ...
        show: function() {
            var that = this,
                ...
                $loadingImage = $('<div id="atlwdg-loading" class="atlwdg-loading"></div>');
            $iframeContainerElem.css("height", "600px");
            ...
            dummyElement.href = "https://issues.scribe.software";
    ...
    ATL_JQ(function() {
        if ("cf33aa12" == "" && typeof ATL_JQ_CONFIGS == "undefined") {
            return
        }
        ...
        if (typeof ATL_JQ_CONFIGS != "undefined") {
            ...
            var baseUrl = "https://issues.scribe.software";
            $.ajax({
                url: baseUrl + "/rest/collectors/1.0/configuration/trigger/cf33aa12?os_authType=none",
                dataType: "jsonp",
                crossDomain: true,
                jsonpCallback: "trigger_cf33aa12",
                cache: true,
                success: function(result) {
                    showTrigger(result, "cf33aa12")
                }
            })
        }
    });
